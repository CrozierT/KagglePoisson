...
import os
# Recuperation des fichier de donnée
for dirname, _, filenames in os.walk('/kaggle/input'):
    for filename in filenames:
        print(os.path.join(dirname, filename))

# Creation du tableu d'output & définition des type de var
...
##########################################################################################
#	Prise en compte des jour spécieux type ramadan & Hanoucca dans la prédiction des prix
##########################################################################################
...
# Different paramètre customisable
params = {
        "objective" : "poisson",
        "metric" :"rmse",
        "force_row_wise" : True,
...
# Création de l'output et sauvegarde dans submission.csv
sub2 = sub.copy()
